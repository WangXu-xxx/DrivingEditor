...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx=None, FoVy=None, cx=None, cy=None, fx=None, fy=None, 
                 ...
                 pts_depth=None, sky_mask=None, objects=None, dynamic_image=None, point_camera=None, point_front=None,
                 point_left=None, point_right=None, point_back=None, bbox_info_1=None
                 ):
        ...
        self.dynamic_image = dynamic_image.clamp(0.0, 1.0) if dynamic_image is not None else dynamic_image
        ...
        self.pointcloud_front = point_front
        self.pointcloud_left = point_left
        self.pointcloud_right = point_right
        self.pointcloud_back = point_back
